...
- Imports transactions in the VCF billing/account currency and preserves source/merchant currency and amount as metadata for foreign-currency card purchases.
