...
define(['N/log', 'N/error'], function (log, nsError) {
    ...
    function toNetSuiteTransaction(transaction, account, cardholder) {
        ...
        return {
            ...
            currency: transaction.billingCurrencyCode || transaction.sourceCurrencyCode,
            payee: payee,
            ...
            additionalFields: stringMap({
                ...
                sourceCurrencyISOCode: transaction.sourceCurrencyCode || transaction.billingCurrencyCode,
                sourceAmount: roundMoney(transaction.sourceAmount),
